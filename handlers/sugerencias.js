    ...
    client.on("messageCreate", async message => {
        try {
            ...
            let botones = new Discord.MessageActionRow().addComponents([
                //votar si
                new Discord.MessageButton().setStyle("SECONDARY").setLabel("0").setCustomId("votar_si").setEmoji('1001487741512589362'),
                //votar no
                new Discord.MessageButton().setStyle("SECONDARY").setLabel("0").setCustomId("votar_no").setEmoji('1001486947396624566'),
                //ver votanes
                new Discord.MessageButton().setStyle("PRIMARY").setLabel("¿Quién ha votado?").setCustomId("ver_votos"),
            ])
            ...
            let msg = await message.channel.send({
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`Sistema de Sugerencias | Kuby`)
                ],
                components: [botones]
            })
